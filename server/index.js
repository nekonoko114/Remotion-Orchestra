...
const TEMPLATES = [
  // --- JOL Battle Series ---
  {
    ...
    name: 'Battle Kawaii (Default)',
    description: 'Pop and cute battle style',
  },
  {
    id: 'JOL-Battle-Inferno',
    name: 'Battle Inferno',
    description: 'Intense fire style',
  },
  {
    id: 'JOL-Battle-Water',
    name: 'Battle Water',
    description: 'Cool water style',
  },
  {
    id: 'JOL-Battle-Crystal',
    name: 'Battle Crystal',
    description: 'Shiny crystal style',
  },
  {
    id: 'JOL-Battle',
    name: 'Battle Standard',
    description: 'Standard crystal battle',
  },

  // --- JOL Ranking Series ---
  {
    id: 'JOL-Ranking-Vertical',
    name: 'JOL Ranking Vertical',
    description: 'Standard vertical ranking',
  },
  {
    id: 'JOL-Ranking-time',
    name: 'JOL Ranking Time',
    description: 'Time-based ranking layout',
  },
  {
    id: 'JOL-Video',
    name: 'JOL Video',
    description: 'General purpose 60fps video',
  },
  ...
  // --- TikTok Liver Series ---
  {
    id: 'TikTokBattle',
    name: 'TikTok Battle',
    description: 'TikTok specific battle layout',
  },
  {
    id: 'TikTokRanking',
    name: 'TikTok Ranking',
    description: 'TikTok specific ranking layout',
  },
  {
    id: 'TikTokAutoCut',
    name: 'TikTok AutoCut',
    description: 'Automated cutting composition',
  },
  {
    id: 'LiverFormatter',
    name: 'Liver Formatter',
    description: 'Jump cut automation for streams',
  },
  {
    id: 'CatRabbitEnjoy',
    name: 'Cat & Rabbit Enjoy',
    description: 'Automated character animation',
  },

  // --- VFX & Storytelling ---
  {
    id: 'CyberpunkBattle',
    name: 'Cyberpunk Battle',
    description: 'Neon cyberpunk style',
  },
  {
    id: 'CatsAdventure',
    name: 'Cats Adventure',
    description: 'Storytelling adventure style',
  },
  {
    id: 'ThreeDTextScene',
    name: '3D Text Scene',
    description: '3D Text rendering scene',
  },
  {
    id: 'VFXShowreel',
    name: 'VFX Showreel',
    description: 'Showcase of visual effects',
  },
  {
    id: 'EffectsCatalog',
    name: 'Effects Catalog',
    description: 'Catalog of available effects',
  },

  // --- Utility & Testing ---
  {
    id: 'JsonDrivenVideo',
    name: 'JSON Driven Video',
    description: 'Fully JSON configured video',
  },
  {
    id: 'PCRanking',
    name: 'PC Ranking',
    description: 'Horizontal ranking layout',
  },
  {
    id: 'AssetCatalog',
    name: 'Asset Catalog',
...
app.get('/api/assets', (req, res) => {
  ...
  const icons = listFiles(
    path.join(PUBLIC_DIR, 'video-factory/images/icons'),
    'Icon',
    'video-factory/images/icons',
  );
  const narrations = listFiles(
    path.join(PUBLIC_DIR, 'audio/narration'),
    'Narration',
    'audio/narration',
  );
  const music = listFiles(
    path.join(PUBLIC_DIR, 'assets/audio/music'),
    'Music',
    'assets/audio/music',
  );
