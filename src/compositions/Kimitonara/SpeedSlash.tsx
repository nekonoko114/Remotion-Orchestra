...
export const SpeedSlash: React.FC = () => {
    ...
    const opacity = interpolate(progress, [0.8, 1], [1, 0], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
        ...
        <AbsoluteFill style={{ overflow: 'hidden' }}>
            ...
            <div
                style={{
                    ...
                    width: '200%', // 画面より長く！
                    height: '100px', // 帯の太さ
                    background: 'linear-gradient(90deg, transparent, #A020F0, #FFFFFF, #A020F0, transparent)', // 発光する紫のグラデーション
                    top: '60%', // 出現する高さ
                    left: '-50%', // 初期位置調整
