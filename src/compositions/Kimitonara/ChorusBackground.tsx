        ...
        return (
            <div
                ...
                style={{
                    ...
                    height: '200px',
                    // Cool Blue/Cyan Rays
                    background: 'linear-gradient(90deg, rgba(100,200,255,0) 0%, rgba(100,200,255,0.2) 50%, rgba(100,200,255,0) 100%)',
    ...
    return (
        <AbsoluteFill 
            ...
            style={{
                ...
                background: 'radial-gradient(circle at center, #2a004f 0%, #1a0033 40%, #000000 100%)',
                overflow: 'hidden',
                zIndex: -1,
            }}
        >
            ...
            <div style={{
                position: 'absolute',
                inset: 0,
                background: 'radial-gradient(circle at center, rgba(100,100,255,0.2) 0%, transparent 70%)',
