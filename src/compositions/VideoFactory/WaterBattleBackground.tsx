...
const Plankton: React.FC<{ seed: number; frame: number }> = ({
  seed,
  frame,
}) => {
  ...
  return (
    <AbsoluteFill style={{ overflow: 'hidden', backgroundColor: '#000b1a' }}>
      ...
      <AbsoluteFill style={{ overflow: 'hidden' }}>
        <Img
          src={staticFile(
            'video-factory/images/backgrounds/water/mermaid_bg_02.png',
          )}
          style={{
            width: '120%',
            height: '120%',
        ...
        <AbsoluteFill
          style={{
            background:
              'radial-gradient(circle at 50% 50%, transparent 30%, #000b1a 100%)',
      ...
      <div
        style={{
          ...
          height: '100%',
          background:
            'linear-gradient(to bottom, rgba(0,229,255,0.3) 0%, transparent 40%)',
          filter: 'blur(50px)',
          opacity: 0.5,
          mixBlendMode: 'screen',
        }}
