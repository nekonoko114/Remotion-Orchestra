  ...
  return (
    <svg viewBox="0 0 110 110" style={{ width: 220, height: 220 }}>
      ...
      <path
        ...
        strokeWidth="10"
        style={{ filter: "blur(10px)", transform: "translate(5px, 5px)", opacity: Math.max(0, Math.min(1, (frame-delay)/20)) }}
      />
      {/* Main morphing path */}
      <path
        ref={pathRef}
	...
	return (
		<AbsoluteFill style={{ backgroundColor: "#FFF0F5" }}>
					...
					<div style={{
						...
						<div style={{
							...
							<div style={{ 
								...
								textShadow: "3px 3px 0px white, -3px -3px 0px white, 3px -3px 0px white, -3px 4px 0px white, 0 0 20px #FFD700",
								textAlign: "center",
								lineHeight: 1.2,
						...
						<div style={{ 
							...
							<div style={{ fontSize: 160, color: "#FF1493", fontWeight: "bold", fontFamily, marginBottom: 20, textShadow: "3px 3px 0px white" }}>21:30</div>
							<div style={{ 
			...
			<Sequence from={startJol} durationInFrames={JOL_INTRO_DURATION}>
				...
				<AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
					<svg width="800" height="200" viewBox="0 0 800 200" style={{
						position: "absolute",
						top: 150,
						overflow: "visible",
						...
						<defs>
							<linearGradient id="jolGradient" x1="0%" y1="0%" x2="100%" y2="100%">
			...
			<Sequence from={startVs} durationInFrames={VS_RULES_DURATION}>
				<AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
					<div style={{
						...
						<div style={{ marginTop: 40, fontSize: 60, color: "#555", fontWeight: "bold", textAlign: "center" }}>
				...
				<AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
					<div style={{
						...
						<h2 style={{ 
							...
							fontFamily: kawaiiFont,
							lineHeight: 1.3,
							textShadow: "5px 5px 0px white, -5px -5px 0px white, 5px -5px 0px white, -5px 5px 0px white",
							display: "flex",
							flexDirection: "column",
							alignItems: "center",
							wordBreak: "keep-all"
							...
							<div>
								{"初の誕生日イベント！じゅんの大切な仲間".split("").map((char, i) => (
									<span 
										key={i} 
										style={{ 
											display: "inline-block",
											opacity: spring({ frame: frame - startMessage, fps, delay: i * 2 }),
							...
							<div>
								{"集まってくれると凄く嬉しいです！".split("").map((char, i) => (
									<span 
										...
										style={{ 
											display: "inline-block",
											opacity: spring({ frame: frame - startMessage, fps, delay: 20 + i * 2 }),
					...
					{new Array(8).fill(0).map((_, i) => (
						<div key={`msg-heart-${i}`} style={{
							position: "absolute",
							left: `${10 + (i * 12)}%`,
							bottom: 150 + Math.sin(i * 99) * 100,
							fontSize: 80,
							opacity: interpolate(frame - startMessage, [0 + i * 5, 20 + i * 5, 40 + i * 5], [0, 1, 0], { extrapolateRight: "clamp" }),
