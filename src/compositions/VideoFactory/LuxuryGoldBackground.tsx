import { AbsoluteFill, staticFile, OffthreadVideo, Loop } from 'remotion';
...
const getColorVideo = (color: string) => {
  ...
  if (c.includes('4444') || c.includes('ruby') || c.includes('f00'))
    return 'red_loop.mp4';
  if (c.includes('44ff') || c.includes('emerald') || c.includes('0f0'))
    return 'green_loop.mp4';
  if (c.includes('4488') || c.includes('sapphire') || c.includes('00f'))
    return 'blue_loop.mp4';
  if (c.includes('bb44') || c.includes('amethyst') || c.includes('800080'))
    return 'purple_loop.mp4';
    ...
    <AbsoluteFill style={{ overflow: 'hidden', backgroundColor: '#000' }}>
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'radial-gradient(circle at center, transparent 30%, rgba(0,0,0,0.8) 120%)',
          zIndex: 2,
          pointerEvents: 'none',
        }}
      />
