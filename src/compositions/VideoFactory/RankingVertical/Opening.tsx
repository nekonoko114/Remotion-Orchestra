  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <NeonGlowText text="J.O.L" fontSize={230} color="#FF0000" glowColor="#CC0000" delay={5} />
          <NeonGlowText text="ダイヤモンド" fontSize={120} color="#00f2ff" glowColor="#0088ff" delay={20} />
          <div style={{ display: 'flex', alignItems: 'center', gap: '40px' }}>
            <NeonGlowText text="RANKING" fontSize={160} color="#FFD700" glowColor="#FF8C00" delay={35} />
          </div>
