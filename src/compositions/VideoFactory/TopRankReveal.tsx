  ...
  return (
    <AbsoluteFill>
      ...
      <AbsoluteFill>
        ...
        <AbsoluteFill
          style={{
            backgroundColor: rank === 1 ? 'rgba(0,0,0,0.2)' : 'rgba(0,0,0,0.0)',
          }}
        />{' '}
        {/* 2位3位は暗くないように */}
      </AbsoluteFill>
      ...
      <AbsoluteFill
        style={{ opacity: 0.4, pointerEvents: 'none', zIndex: 110 }}
      >
      ...
      {rank === 1 && (
        <>
          ...
          <AbsoluteFill
            style={{ zIndex: 8, pointerEvents: 'none', mixBlendMode: 'screen' }}
          >
            <div
              style={{
                position: 'absolute',
                ...
                background:
                  'radial-gradient(circle, rgba(255,215,0,0) 40%, rgba(255,215,0,0.1) 50%, rgba(255,215,0,0) 60%)',
