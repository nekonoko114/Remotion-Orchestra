...
export const CrystalBackground: React.FC = () => {
	...
	return (
		<AbsoluteFill
			style={{
				background: "linear-gradient(135deg, #020b1a 0%, #0a1f3d 50%, #050a14 100%)",
			}}
		>
			{/* Ambient Glows */}
			<AbsoluteFill
			...
			<AbsoluteFill
				style={{
					background: "radial-gradient(circle at 80% 70%, rgba(170, 0, 255, 0.1) 0%, transparent 60%)",
				}}
			/>
			...
			<AbsoluteFill
				style={{
					background: "repeating-linear-gradient(45deg, transparent, rgba(255,255,255,0.03) 100px, transparent 200px)",
					opacity: 0.5,
				}}
			/>
