    ...
    <AbsoluteFill>
      ...
      <AbsoluteFill>
        <TransitionSeries>
          ...
          <TransitionSeries.Transition presentation={wipeTransition({ direction: 'from-left' })} timing={timing} />
          ...
          <TransitionSeries.Transition presentation={wipeTransition({ direction: 'from-right' })} timing={timing} />
          ...
          <TransitionSeries.Transition presentation={wipeTransition({ direction: 'from-top' })} timing={timing} />

          <TransitionSeries.Sequence durationInFrames={GRID_BRIDGE_DURATION}>
            <GridBridge />
          </TransitionSeries.Sequence>

          <TransitionSeries.Transition presentation={wipeTransition({ direction: 'from-bottom' })} timing={timing} />
