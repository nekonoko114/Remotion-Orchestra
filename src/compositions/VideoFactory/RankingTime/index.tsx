    ...
    <AbsoluteFill>
      ...
      <AbsoluteFill>
        <TransitionSeries>
          ...
          <TransitionSeries.Transition presentation={flipTransition({ direction: 'from-right' })} timing={timing} />
          ...
          <TransitionSeries.Transition presentation={flipTransition({ direction: 'from-left' })} timing={timing} />

          <TransitionSeries.Sequence durationInFrames={GROUP_DURATION}>
            <RankingGroup title={'TOP7~6'} livers={RANKING_DATA.filter((d) => d.rank >= 6 && d.rank <= 7)} />
          </TransitionSeries.Sequence>

          <TransitionSeries.Transition presentation={flipTransition({ direction: 'from-top' })} timing={timing} />

          <TransitionSeries.Sequence durationInFrames={GROUP_DURATION}>
            <RankingGroup title={'TOP5~4'} livers={RANKING_DATA.filter((d) => d.rank >= 4 && d.rank <= 5)} />
          </TransitionSeries.Sequence>

          <TransitionSeries.Transition presentation={flipTransition({ direction: 'from-bottom' })} timing={timing} />
