...
import { cyberGateTransition } from '../../../components/effects/transitions/CyberGateTransition'; 

import { useCurrentFrame } from 'remotion';
import RANKING_DATA_EVENT_JSON from '../../../data/data-event.json';
...
export const TOTAL_DURATION_FRAMES =
  (OPENING_SEC +
    GROUP_SEC * 2 +
    (SCAN_SEC + REVEAL_SEC) * 4 +
    (SCAN_SEC + REVEAL_1_SEC) +
    ENDING_SEC) *
    60 -
...
import { RankingEventProps } from './schema';

export const RankingEvent: React.FC<RankingEventProps> = (props) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: 'rgb(0,0,0,0.5)' }}>
      ...
      <AbsoluteFill>
        <TransitionSeries>
          <TransitionSeries.Sequence durationInFrames={OPENING_DURATION + TRANSITION_FRAMES}>
            <Opening 
              title1={props.openingTitle1}
              title2={props.openingTitle2}
              title3={props.openingTitle3}
              subtitle={props.openingSubtitle}
