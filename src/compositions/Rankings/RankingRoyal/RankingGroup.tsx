...
import { LuxuryGoldText } from '../../../components/effects/LuxuryGoldText';
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: 4, flex: 1, whiteSpace: 'nowrap' }}>
                    ...
                    <span style={{
                        fontSize: liver.nickname.length > 14 ? nameFontSize * 0.7 : liver.nickname.length > 10 ? nameFontSize * 0.8 : nameFontSize, fontWeight: 800, color: ROYAL_THEME.colors.textWhite,
            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <span style={{
                        fontSize: liver.nickname.length > 14 ? nameFontSize * 0.9 * 0.7 : liver.nickname.length > 10 ? nameFontSize * 0.9 * 0.8 : nameFontSize * 0.9, fontWeight: 800, color: ROYAL_THEME.colors.textWhite,
                        textShadow: `0 4px 15px rgba(0,0,0,0.9), 0 0 10px ${ROYAL_THEME.colors.goldGlow}`,
