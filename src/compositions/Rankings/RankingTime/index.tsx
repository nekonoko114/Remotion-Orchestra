...
import { TimeBackground } from '../../../components/backgrounds/TimeBackground';
import { AbsoluteFill, useVideoConfig, Audio, staticFile } from 'remotion';
import RANKING_DATA_TIME_JSON from '../../../data/data-time.json';
...
const FURTHER_BG = staticFile('backgrounds/I_want_to_202604221429.webm');
