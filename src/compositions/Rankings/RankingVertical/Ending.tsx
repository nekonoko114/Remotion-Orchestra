    ...
    <AbsoluteFill style={{ backgroundColor: '#000' }}>
      ...
      <AbsoluteFill>
        <OffthreadVideo
          ...
          style={{ width: '100%', height: '100%', objectFit: 'cover', mixBlendMode: 'screen', filter: 'contrast(1.5) brightness(0.8)' }}
          muted
        />
      </AbsoluteFill>
      ...
      <AbsoluteFill style={{ background: 'radial-gradient(circle, transparent 30%, rgba(0,0,0,0.8) 100%)', pointerEvents: 'none' }} />
    </AbsoluteFill>
  );
};
