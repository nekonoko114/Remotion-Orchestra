...
export const RankingVerticalSchema = z.object({
  ...
  openingVideo: z.string().default('assets/pixabay/videos/webm/pixabay_sword_diamond_nice_hd_background_of_screen_minecra_99299.webm'),
  rankingVideo: z.string().default('assets/pixabay/videos/webm/pixabay_fire_flame_beautiful_wallpaper_burn_hot_smoke_feve_200715.webm'),
  ...
  top3Video: z.string().default('assets/pixabay/videos/webm/pixabay_dimension_space_psychedelic_abstract_portal_time_w_31183.webm'),
