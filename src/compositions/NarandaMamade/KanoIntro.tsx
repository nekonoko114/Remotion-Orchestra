...
export const KanoIntro: React.FC = () => {
	...
	const starDraw = interpolate(frame, [0, 45], [1, 0], { extrapolateRight: 'clamp' });
	const textOpacity = interpolate(frame, [40, 70], [0, 1], { extrapolateLeft: 'clamp' });
	...
	return (
		<AbsoluteFill style={{ backgroundColor: 'white', justifyContent: 'center', alignItems: 'center' }}>
			<svg width="600" height="400" viewBox="0 0 600 400" fill="none" xmlns="http://www.w3.org/2000/svg">
				{/* KNロゴ部分 */}
				<g style={{ transform: `scale(${interpolate(spr, [0, 1], [0.8, 1])})`, transformOrigin: 'center' }}>
					{/* Kの文字 */}
					<path
						d="M150 100V300L220 200L150 100ZM220 200L280 100H320L240 200L320 300H280L220 200Z"
						fill="#4B0082" // 深い紫
						style={{ opacity: textOpacity, transform: `translateX(${kTranslate}px)` }}
					/>
					...
					<path
						...
						fill="#4B0082"
						style={{ opacity: textOpacity, transform: `translateX(${nTranslate}px)` }}
					/>
