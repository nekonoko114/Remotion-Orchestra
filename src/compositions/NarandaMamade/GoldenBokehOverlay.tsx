...
export const GoldenBokehOverlay: React.FC<{ startFrame: number }> = ({ startFrame }) => {
    ...
    const breath = interpolate(Math.sin(relativeFrame * 0.02), [-1, 1], [0.8, 1.2]);
    ...
    return (
        <AbsoluteFill style={{ opacity, zIndex: 50, pointerEvents: 'none' }}>
            ...
            {/* 1. Dreamy Soft Focus Background tint */}
             <AbsoluteFill style={{
                background: 'radial-gradient(circle at 50% 30%, rgba(255, 250, 200, 0.15), transparent 70%)',
                mixBlendMode: 'screen',
                filter: 'blur(30px)',
            }} />
            ...
            {/* 4. Mystical Sparkles (Sharper, intense points of light) */}
                 ...
                 return (
                     <div
                        ...
                        style={{
                            ...
                            boxShadow: '0 0 10px 2px rgba(255, 255, 255, 0.9), 0 0 20px 5px rgba(255, 215, 0, 0.5)', // Intense glow
             ...
             <AbsoluteFill style={{
                 background: 'radial-gradient(circle, transparent 60%, rgba(50, 0, 50, 0.3) 100%)',
