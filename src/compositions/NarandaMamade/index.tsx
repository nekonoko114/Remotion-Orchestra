...
const VERIFIED_NOVA_IMAGES = [
    staticFile(`${ASSET_PREFIX}assets/generated/nanobana/nova_scene_01_waking_up.webp`),
    staticFile(`${ASSET_PREFIX}assets/generated/nanobana/nova_scene_02_morning_coffee.webp`),
    staticFile(`${ASSET_PREFIX}assets/generated/nanobana/nova_scene_03_breakfast_toast.webp`),
    staticFile(`${ASSET_PREFIX}assets/generated/nanobana/nova_scene_04_reading_sofa.webp`),
    staticFile(`${ASSET_PREFIX}assets/generated/nanobana/nova_scene_05_balcony_plants.webp`),
    staticFile(`${ASSET_PREFIX}assets/generated/nanobana/nova_scene_06_getting_ready.webp`),
...
const DUO_PLACEHOLDER = staticFile(`${ASSET_PREFIX}assets/characters/nova-shige.webp`);
                ...
                {LYRIC_GROUPS.map((group, index) => {
                    ...
                    return (
                        <Sequence 
                            ...
                            name={index === LYRIC_GROUPS.length - 1 ? "Epilogue (Memories & Duo)" : `Scene ${index + 1}: ${group[0].text.substring(0, 10)}...`}
                        >
