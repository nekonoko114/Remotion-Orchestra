...
} from '../Battles/shared/EffectsMega15';
import {
...
} from '../Battles/shared/EffectsUltra15';
import { whiteSnowTheme } from '../Battles/JolBattleWhiteSnow';
...
// --- 1. Backgrounds ---
const bgItems = [
  { name: 'PanningVideoBg', render: (f: number) => <PanningVideoBackground src="assets/pixabay/videos/webm/pixabay_snow_globe_snowman_christmas_texture_snow_particle_98978.webm" frame={f} startFrame={0} duration={90} startX={0} endX={-50} zIndex={1} /> },
...
// --- 2. Effects ---
const fxItems = [
  { name: 'GreenScreenOverlay', render: (f: number) => <GreenScreenOverlay src="assets/pixabay/videos/webm/pixabay_heart_sparkle_overlay_green_screen_4k_love_gold_he_111573.webm" frame={f} startFrame={0} zIndex={10} /> },
