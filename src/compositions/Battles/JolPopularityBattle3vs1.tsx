...
const Scene_Opening: React.FC<{ dateInfo: Props['dateInfo'] }> = ({ dateInfo }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: 'transparent', justifyContent: 'start', alignItems: 'center', opacity: globalOpacity }}>
      ...
      <Video 
        src={staticFile('assets/pixabay/videos/webm/pixabay_hearts_line_motion_heart_motion_love_motion_love_h_151653.webm')} 
        style={{ 
          position: 'absolute', 
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center' }}>
      ...
      <AbsoluteFill style={{ 
        ...
        <Video 
          src={staticFile('assets/pixabay/videos/webm/pixabay_hearts_valentines_beautiful_wallpaper_love_romanti_32261.webm')} 
          playbackRate={0.8}
