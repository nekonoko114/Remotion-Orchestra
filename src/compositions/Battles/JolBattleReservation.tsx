...
import { z } from 'zod';
import { BurningLightningText, StarburstCoreText } from './shared/BattleSharedComponents';
...
const Scene5_Ending: React.FC<{ msg: string; themeColor: string; livers: Props['livers'] }> = ({ msg, themeColor, livers }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#fff', justifyContent: 'end', alignItems: 'center', opacity }}>
      ...
      <AbsoluteFill>
        <Video
          src={staticFile('assets/pixabay/videos/webm/boken-ball.webm')}
          style={{ width: '100%', height: '100%', objectFit: 'cover' }}
        />
        <AbsoluteFill  />
      </AbsoluteFill>
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#000', perspective: '1200px' }}>
      ...
      <Sequence from={315} durationInFrames={240}>
        <AbsoluteFill>
          <Video
            src={staticFile('assets/pixabay/videos/webm/five-element-explosion.webm')}
            style={{ 
              width: '100%', height: '100%', objectFit: 'cover',
